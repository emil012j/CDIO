    ...
    try:
        while True:
            ...
            if current_state == COLLECTING:
                print("[DEBUG] State: COLLECTING")  # <--- DEBUG
                print("[DEBUG] current_run_balls:", current_run_balls, "balls:", balls)  # <--- DEBUG
                if current_run_balls >= STORAGE_CAPACITY:
                    ...
                    print("[DEBUG] remaining_balls:", remaining_balls)  # <--- DEBUG
                    ...
                    print("[DEBUG] target_ball:", target_ball)  # <--- DEBUG
                    if target_ball:
